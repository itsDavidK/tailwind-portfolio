...
const DotGroup = ({ selectedPage, setSelectedPage }) => {
    const selectedStyles = `relative bg-lavender before:absolute before:w-6 before:h-6
    before:rounded-full before:border-2 before:border-lavender before:left-[-50%]
    before:top-[-50%]`;
